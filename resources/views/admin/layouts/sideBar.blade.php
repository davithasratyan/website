...
{{--                <span class="py-1">Ավելացնել կատեգորիա</span>--}}
{{--            </a>--}}
{{--        </li>--}}
{{--        <li class="py-2">--}}
{{--            <a href="{{route('addMediaIcons')}}" class="nav-link text-white">--}}
{{--                <i class="fa fa-heart-o"></i>--}}
{{--                <span class="py-1">Ավելացնել սոցցանց</span>--}}
{{--            </a>--}}
{{--        </li>--}}
{{--    </ul>--}}
{{--    @endif--}}
